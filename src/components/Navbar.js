...
function Navbar() {
    ...
    return (
        <>
            <nav className="bg-midnight h-[80px] flex justify-end sm:justify-between items-center px-[5%] text-white font-bold">
            ...
            {isMenuOpen && (
                <nav className="bg-midnight h-[calc(100vh-80px)] flex items-center text-white font-semibold">
